                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="forms">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/movie_list.php">Movies List</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form_cinema">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/cinema.php">Cinema list</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/cinema_has_seats.php">Cinema Detail</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="schedules">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/schedule.php">Screening Schedules</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/movie_schedule.php">Movie Schedules</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/samples/blank-page.php"> Blank Page </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/samples/login.php"> Login </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/samples/register.php"> Register </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/samples/error-404.php"> 404 </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cashier/pages/samples/error-500.php"> 500 </a>
                                </li>
                            </ul>
                        </div>
                    </li>
